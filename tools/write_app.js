...
fs.writeFileSync('apps/web/src/main.tsx', `import React from 'react';
...
fs.writeFileSync('apps/web/src/App.tsx', `import React, { useState } from 'react';
...
console.log('main.tsx and App.tsx created.');
