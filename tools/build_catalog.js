...
fs.writeFileSync('apps/api/src/data/missions-catalog.ts', `import { PostgresMissionSandbox } from '../sandbox/postgres-engine.js';
...
console.log('missions-catalog.ts written.');
